describe('Automation Exercise Website Tests', () => {
  ...
  //need to configure before use this?
  beforeEach(() => {
    // This will run before each test to ensure the website is visited first
    cy.visit('/');
  });
  ...
  it('should navigate to the website', () => {
    ...
    //cy.xpath('//h2[contains(text(),"Features Items")]').should('exist'); or
    cy.get('img[src="/static/images/home/logo.png"]').should('exist');
  });

  it('should perform Sign Up process', () => {
